...
void ServiceRegistry::set_related_sample_identity(
...
bool ServiceRegistry::is_request_topic(
        const RealTopic& topic)
{
...
bool ServiceRegistry::is_reply_topic(
        const RealTopic& topic)
{
    std::string topic_name = topic.topic_name();
    std::string topic_type = topic.topic_type();
...
bool ServiceRegistry::is_service_topic(
        const RealTopic& topic)
{
