...
RequestWriter::RequestWriter(
    ...
    : Writer(participant_id, topic, payload_pool, rtps_participant)
        ...
        std::unique_ptr<DataReceived>& data) noexcept
{
    ...
    // SampleIdentity request_related_sample_identity(service_registry_->reader_guid); // or take it from Data.hpp
    ...
    wparams.related_sample_identity(service_registry_->related_sample_identity());
