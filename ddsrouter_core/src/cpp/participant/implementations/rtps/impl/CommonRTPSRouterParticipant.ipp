        ...
        DiscoveryInfoKind& info)
{
    ...
    {
        return types::Endpoint(types::EndpointKind::READER, info_guid, info_qos, info_topic, this->id());
    }
    else if (std::is_same<DiscoveryInfoKind, fastrtps::rtps::WriterDiscoveryInfo>::value)
    {
        return types::Endpoint(types::EndpointKind::WRITER, info_guid, info_qos, info_topic, this->id());
    }
    else
    {
