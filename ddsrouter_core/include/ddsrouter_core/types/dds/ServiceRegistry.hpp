...
public:
    ...
    void set_related_sample_identity(const Guid& reply_reader_guid);

    SampleIdentity related_sample_identity();

    void add(SequenceNumber idx, std::pair<ParticipantId, SampleIdentity> new_entry);

    std::pair<ParticipantId, SampleIdentity> get(SequenceNumber idx);
